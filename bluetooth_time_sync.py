...
def bluetooth_spp_server():
    """
    Sets up an RFCOMM-based (SPP) Bluetooth server to receive time data.
    Use an Android app like 'Serial Bluetooth Terminal' to connect
    and send a string (e.g. '2025-02-20 10:30:00').
    """
    ...
    # 2. Advertise our Serial Port service
    ...
    print("🔎 Make sure your Pi is discoverable and pairable (see instructions below).")
